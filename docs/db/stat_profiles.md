...
| ---------- | -------- | ------------------------------------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| id         | TEXT     |                                      | true     | [combatants](combatants.md) [player_characters](player_characters.md) [stat_profile_resistance_by_location](stat_profile_resistance_by_location.md) [monster_templates](monster_templates.md) |
