...
| ---------- | -------- | ------------------------------------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| id         | TEXT     |                                      | true     | [stat_profile_resistance_global](stat_profile_resistance_global.md) [stat_profile_resistance_by_location](stat_profile_resistance_by_location.md) [combatants](combatants.md) [player_characters](player_characters.md) [monster_templates](monster_templates.md) |
